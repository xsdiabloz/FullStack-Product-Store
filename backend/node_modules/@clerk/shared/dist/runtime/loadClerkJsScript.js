...
const require_versionSelector = require('./versionSelector-CGtsGAgs.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.2.3")}/dist/ui.browser.js`;
};
