...
import type { ProductBase, ProductFormValue } from "../types/productTypes";

interface ProductFormProps {
  product: ProductBase;
  isPending: boolean;
  isError: boolean;
  onSubmit: (formData: ProductFormValue) => void;
}
...
const EditProductForm = ({
  ...
  const [formData, setFormData] = useState<Omit<ProductBase, "userId">>({
    title: product.title,
